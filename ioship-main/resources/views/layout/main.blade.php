    ...
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
			...
			<li><a href="#adminMenu" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document-remove"></i><span>{{__('file.adminMenu')}}</span><span></a>
            <ul id="adminMenu" class="collapse list-unstyled ">
			
				<li id="purchase-approval-menu"><a href="{{route('purchase.paymentpending')}}" > <span>{{ __('file.Pending Approval') }}</span></a></li>
			</ul>
            ...
            <ul id="product" class="collapse list-unstyled ">
                <!-- category commented here and moved under settings by usha -->
                <!-- @if($category_permission_active)
                <li id="category-menu"><a href="{{route('category.index')}}">{{__('file.category')}}</a></li>
                @endif -->
                @if($index_permission_active)
                <li id="product-list-menu"><a href="{{route('products.index')}}">{{__('file.product_list_master')}}</a></li>
                <?php
                ...
                <a id="purchase-report-link" href="">{{trans('file.Warehouse Product List')}}</a>
                {!! Form::close() !!}
                </li>
                @endif
                ...
                <li id="printRackBarcode-menu"><a href="{{route('product.printRackBarcode')}}">{{__('file.print_rack_barcode')}}</a></li>
                @endif
                ...
                <li id="stock-count-menu"><a href="{{route('stock-countpurchase.index')}}">{{trans('file.Stock Count')}}</a></li>
                @endif
            </ul>
            </li>
            @endif
            ...
            <ul id="purchase" class="collapse list-unstyled ">
                <!--<li id="purchase-approval-menu"><a href="{{route('purchase.paymentpending')}}">{{trans('file.Pending Approval')}}</a></li>-->
            ...
            ?>
            <!-- Sale Menu moved from here - Deep -->
            ...
            ?>
            @if($index_permission_active && "true"=="false")
            ...
            ?>
            @if(($sale_return_index_permission_active || $purchase_return_index_permission_active) && "true"=="false")
            ...
            ?>
            @if(($index_permission_active || $balance_sheet_permission_active || $account_statement_permission_active || $money_transfer_permission_active) && "true"=="false")
            ...
            <ul id="sale" class="collapse list-unstyled ">
                ...
                <li id="quickpick-create-menu"><a href="{{route('quickpick.create')}}">{{trans('file.Quick Pick')}}</a></li>
            ...
            <ul id="report" class="collapse list-unstyled ">
                @if($profit_loss_active && "true"=="false")
                ...
                @endif
                @if($best_seller_active && "true"=="false")
                ...
                @endif
                @if($daily_sale_active && "true"=="false")
                ...
                @endif
                @if($daily_purchase_active && "true"=="false")
                ...
                @endif
                @if($sale_report_active && "true"=="false")
                ...
                @endif
                @if($payment_report_active && "true"=="false")
                ...
                @endif
                @if($product_expiry_report_active && "true"=="false")
				...
				<li id="pickingreport-report-menu">
                <a href="{{route('report.pickingreport')}}">Picking Report</a>
                </li>
				<li id="orderdetailreport-report-menu">
                <a href="{{route('report.orderdetailreport')}}">Order Detail</a>
                </li>
				<li id="inventorystatusreport-report-menu">
                <a href="{{route('report.inventorystatusreport')}}">Inventory Status Report</a>
                </li>
				
                @if($due_report_active && "true"=="false")
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    ?>
                    <!-- category added under settings on 4/4/23 by usha -->
                    @if($category_permission_active)
                <li id="category-menu"><a href="{{route('category.index')}}">{{__('file.category')}}</a></li>
                @endif
                    @if($role->id <= 2)
