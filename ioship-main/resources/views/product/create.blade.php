                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <!-- removed generate button by usha on 4/4/2023 -->
                                ...
                                <div id="unit" class="col-md-12">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-4 form-group">
                                                <label>{{trans('file.Boxes')}} * </label>
                                                <div class="input-group">
                                                    <input type="number" name="boxes" class="form-control" placeholder="Enter No. of Each in 1 Box">
                                              </div>
                                              <span class="validation-msg"></span>
                                        </div>

                                        <div class="col-md-4 form-group">
                                                <label>{{trans('file.Carton')}} * </label>
                                                <div class="input-group">
                                                <input type="number" name="carton" class="form-control" placeholder="Enter No. of Boxes in 1 Carton">
                                              </div>
                                              <span class="validation-msg"></span>
                                        </div>

                                        <div class="col-md-4 form-group">
                                                <label>{{trans('file.Pallet')}} * </label>
                                                <div class="input-group">
                                                <input type="number" name="pallette" class="form-control" placeholder="Enter No. of Cartons in 1 Pallet">
                                              </div>
                                              <span class="validation-msg"></span>
                                        </div>
                                    </div>
								...
								<div id="par-qty" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Par Quantity')}}</label>
                                        <input type="number" name="par_quantity" class="form-control" step="any">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Dependent Product')}}</label>
                                        <div class="input-group">
                                          <select name="dependent_dropdown_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Dependent Product...">
								...
								<!--- Start Weight , Dimensions --->
								<div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Weight')}}</label>
                                        <input type="number" id="weight" name="weight" class="form-control" step="any" min=0>
                                    </div>
                                </div>
								<div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Dimensions')}}</label>
										<div class="row">
											<div class="col-md-4">
												<input type="number" id="dm_length" name="dm_length" class="form-control" step="any" min=0 placeholder="Length" />
											</div>
											<div class="col-md-4">
												<input type="number" id="dm_width" name="dm_width" class="form-control" step="any" min=0 placeholder="Width" >
											</div>
											<div class="col-md-4">
												<input type="number" id="dm_height" name="dm_height" class="form-control" step="any" min=0 placeholder="Height" >
											</div>
										</div>
                                    </div>
                                </div>
