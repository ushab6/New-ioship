        ...
        <table id="product-data-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <!-- <th>{{trans('file.Dependent Product')}}</th> -->
                    <th>{{trans('file.On Hand Quantity')}}</th>
                    <th>{{trans('file.Par Quantity')}}</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
           <p>{{trans('file.The correct column order is')}} (image, product_name*, product_code*, type*, brand, category*, unit_code*, cost*, price*, par_quantity) {{trans('file.and you must follow this')}}.</p>
    ...
    $(document).ready(function() {
        var table = $('#product-data-table').DataTable( {
            ...
            'columnDefs': [
                ...
                // code added to hide fields stock worth and on hand quantity by usha on 5/4/2023
                {
